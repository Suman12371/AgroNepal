...
from .models import Profile, Category, Product, Order, Review, ChatMessage, Cart,Referral, Deal,NewsletterSubscriber,LikedProduct,CoAdmin,DealChatMessage, WalletWithdrawal
...
class WalletWithdrawalAdmin(admin.ModelAdmin):
    ...
    search_fields = ('user__username', 'notes', 'admin_notes')
